...
def readConfigFile(errorHandling):
   ...
   # global LANG
    ...
    try:
        ...
        #DBHost = settings.value("DBHost", "phoenixitsolutions.com.au").toString()
        DBHost = settings.value("DBHost", "61.9.143.196").toString()
        #DBHost = settings.value("DBHost", "192.168.0.23").toString()
        #DBName = settings.value("DBName", "management").toString()
        DBName = settings.value("DBName", "managementnew").toString()
        DBPort = settings.value("DBPort", "3306").toString()
        DBUser = settings.value("DBUser", "anilet").toString()
        DBPass = settings.value("DBPass", "02092089").toString()
...
#        DBHost     = QString("phoenixitsolutions.com.au")
#        DBName     = QString("management")
        DBHost     = QString("61.9.143.196")
        #DBHost     = QString("192.168.0.23")
        DBName     = QString("managementnew")
        DBPort     = QString("3306")
        DBUser     = QString("anilet")
        DBPass     = QString("02092089")
